...
namespace MLAgents
{
    ...
    public abstract class Academy : MonoBehaviour
    {
        ...
        /// </summary>
        public virtual void EnvironmentStep()
        {   
            Debug.Log("Academy.cs: Start Env Step...");
                ...
                (lastCommunicatorMessageNumber != brainBatcher.GetNumberMessageReceived()))
            {
                    ...
                    MLAgents.CommunicatorObjects.CommandProto.Reset)
                {
                    ...
                    Debug.Log("Academy.cs: Forced full reset");
                    ForcedFullReset();
                }
